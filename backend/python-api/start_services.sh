...
echo ""
echo "서비스를 중지하려면:"
echo "kill $CHATBOT_PID $GITHUB_PID $INTERVIEW_PID $PORTFOLIO_PID $QUESTIONS_PID"
echo ""
echo "로그 확인:"
echo "tail -f chatbot/logs.txt github_search/logs.txt interview_analysis/logs.txt portfolio_matching/logs.txt interview_questions/logs.txt"
