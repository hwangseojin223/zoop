...
import java.util.HashMap;import com.zoop.backend.domain.dto.PostingRequestDto;
...
public class RecruitPostingController {
    ...
    private final PostRepository postRepository;    private final JwtUtil jwtUtil; // ✅ 추가됨
